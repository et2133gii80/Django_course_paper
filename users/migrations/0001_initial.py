    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, help_text='введи номер телефона', max_length=35, null=True, verbose_name='телофон')),
                ('first_name', models.CharField(max_length=50, verbose_name='Имя')),
                ('last_name', models.CharField(max_length=50, verbose_name='Фамилия')),
                ('middle_name', models.CharField(blank=True, max_length=50, null=True, verbose_name='Отчество')),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='photo/avatars/', verbose_name='Аватар')),
